...
const manifest: AgentCompanyPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current AgentCompany plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "AgentCompany",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the AgentCompany domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
