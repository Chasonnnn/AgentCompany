import type { PluginLauncherRegistration } from "@agentcompany/plugin-sdk";

export const PLUGIN_ID = "agentcompany-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".agentcompany-kitchen-sink-demo.txt",
} as const;
