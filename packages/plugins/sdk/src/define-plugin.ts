/**
 * `definePlugin` — the top-level helper for authoring a AgentCompany plugin.
 *
...
// ---------------------------------------------------------------------------
// AgentCompanyPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface AgentCompanyPlugin {
 ...
 * @returns A sealed `AgentCompanyPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@agentcompany/plugin-sdk";
