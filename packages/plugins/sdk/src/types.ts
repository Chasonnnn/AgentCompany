/**
 * Core types for the AgentCompany plugin worker-side SDK.
 *
 * These types define the stable public API surface that plugin workers import
 * from `@agentcompany/plugin-sdk`.  The host provides a concrete implementation
...
// ---------------------------------------------------------------------------
// Re-exports from @agentcompany/shared (plugin authors import from one place)
// ---------------------------------------------------------------------------
...
export interface ScopeKey {
  /** What kind of AgentCompany object this state is scoped to. */
...
export interface PluginEntityUpsert {
  ...
  externalId?: string;
  /** Human-readable title for display in the AgentCompany UI. */
  title?: string;
...
/**
 * `ctx.events` — subscribe to and emit AgentCompany domain events.
 *
...
export interface PluginEventsClient {
  /**
   * Subscribe to a core AgentCompany domain event or a plugin-namespaced event.
   *
 ...
 * This client resolves the reference through the AgentCompany secret provider
...
export interface PluginSecretsClient {
   ...
   * in the AgentCompany secret provider (e.g. `"MY_API_KEY"`).
   *
 ...
 * ```
 *
 * @see usePluginStream in `@agentcompany/plugin-sdk/ui`
 */
 ...
 * @example
 * ```ts
 * import { definePlugin } from "@agentcompany/plugin-sdk";
 *
