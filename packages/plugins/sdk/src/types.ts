...
export interface PluginIssuesClient {
  ...
  /** Read and mutate blocker relationships. Requires `issue.relations.*`. */
  relations: PluginIssueRelationsClient;
  /** Read derived orchestration summaries. Requires `issues.orchestration.read`. */
...
export interface PluginContext {
  ...
  /** Access the plugin's restricted database namespace. */
