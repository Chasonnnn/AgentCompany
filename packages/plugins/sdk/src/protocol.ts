 ...
 * channel.
 *
 * The AgentCompany plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@agentcompany/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all AgentCompany messages.
 */
...
/**
 * AgentCompany plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this AgentCompany instance. */
    instanceId: string;
    /** Semver version of the running AgentCompany host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
