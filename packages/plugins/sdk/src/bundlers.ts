/**
 * Bundling presets for AgentCompany plugins.
 *
 ...
 * to match the AgentCompany plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@agentcompany/plugin-sdk/ui",
    "@agentcompany/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const rollupManifest: RollupLikeConfig = {
    ...
    external: ["@agentcompany/plugin-sdk"],
  };
