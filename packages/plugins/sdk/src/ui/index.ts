/**
 * `@agentcompany/plugin-sdk/ui` — AgentCompany plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@agentcompany/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@agentcompany/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@agentcompany/plugin-sdk/ui";
 *
