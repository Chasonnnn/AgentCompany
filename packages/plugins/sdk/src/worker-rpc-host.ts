...
import type { AgentCompanyPluginManifestV1 } from "@agentcompany/shared";

import type { AgentCompanyPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@agentcompany/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: AgentCompanyPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@agentcompany/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
