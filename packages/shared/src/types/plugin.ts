...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within AgentCompanyPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the AgentCompany host.
 *
...
export interface AgentCompanyPluginManifestV1 {
   ...
   */
  minimumAgentCompanyVersion?: PluginMinimumHostVersion;
