...
import type { FeedbackDataSharingPreference, FeedbackVoteValue } from "@agentcompany/shared";
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Choose whether voted AI outputs can be shared with AgentCompany Labs. This
