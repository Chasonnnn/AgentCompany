...
export const help: Record<string, string> = {
  ...
  fastMode: "Enable Codex Fast mode. Eligible Codex/OpenAI models default this on when omitted; it currently applies on GPT-5.4 only and burns credits/tokens much faster.",
