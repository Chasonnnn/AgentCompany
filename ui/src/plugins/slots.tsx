 ...
 *
 * Plugin bundles are built with `external: ["@agentcompany/plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "@agentcompany/plugin-sdk/ui";
 ...
 * - `import { ... } from "@agentcompany/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@agentcompany/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@agentcompany/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@agentcompany/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@agentcompany/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * self-register via `window.agentcompanyPlugins.registerReactComponent()`.
 ...
 * of `@agentcompany/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
