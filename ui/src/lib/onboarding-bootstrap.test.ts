      ...
      [
        {
          ...
          manifestVersion: 1,
          identityDigest: "identity-paperclip-create-agent",
          contentDigest: "content-paperclip-create-agent",
        ...
        },
        {
          ...
          compatibility: "compatible",
          manifestVersion: 1,
          identityDigest: "identity-plan-eng-review",
          contentDigest: "content-plan-eng-review",
          verificationState: "verified",
          compatibilityMetadata: null,
          fileInventory: [],
