export const queryKeys = {
  companies: {
    ...
    productivity: (companyId: string, window: string = "7d") =>
      ["companies", companyId, "productivity", window] as const,
  ...
  agents: {
    ...
    productivity: (id: string, window: string = "7d") => ["agents", "productivity", id, window] as const,
  ...
  issues: {
    ...
    conferenceContext: (issueId: string) => ["issues", "conference-context", issueId] as const,
  ...
  projects: {
    ...
    document: (projectId: string, key: string) => ["projects", "document", projectId, key] as const,
    documentRevisions: (projectId: string, key: string) =>
      ["projects", "document-revisions", projectId, key] as const,
  },
  goals: {
  ...
  access: {
    ...
    invites: (
      companyId: string,
      state: "active" | "revoked" | "accepted" | "expired" | "all" = "all",
      limit: number = 20,
    ) => ["access", "invites", companyId, state, limit] as const,
