import type { Agent, CompanyPortabilitySidebarOrder, Project } from "@agentcompany/shared";
import { deriveProjectUrlKey, normalizeAgentUrlKey } from "@agentcompany/shared";
