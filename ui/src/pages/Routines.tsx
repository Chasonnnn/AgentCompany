...
import type { RoutineListItem, RoutineVariable } from "@agentcompany/shared";
...
export function Routines() {
  ...
  const routineViewStateKey = selectedCompanyId
    ? `agentcompany:routines-view:${selectedCompanyId}`
    : "agentcompany:routines-view";
  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "AgentCompany could not update the routine.",
        tone: "error",
      });
    },
  });
  ...
  const runRoutine = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "AgentCompany could not start the routine run.",
        tone: "error",
      });
    },
  });
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        ...
        <TabsContent value="runs">
          <IssuesList
            ...
            viewStateKey="agentcompany:routine-recent-runs-view"
        ...
        >
          ...
          <div className="shrink-0 flex flex-col gap-3 border-t border-border/60 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-sm text-muted-foreground">
              After creation, AgentCompany takes you straight to trigger setup for schedules, webhooks, or internal runs.
            </div>
