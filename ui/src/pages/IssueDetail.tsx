...
export function IssueDetail() {
  ...
  const queuedCommentReason: "hold" | "active_run" | "other" =
    treeControlState?.activePauseHold ? "hold" : "active_run";
  ...
  }, [activity, threadComments, linkedRuns, liveRunIds, locallyQueuedCommentRunIds, queuedCommentReason, runningIssueRun]);
