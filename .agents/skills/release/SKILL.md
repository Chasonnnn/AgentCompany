...
name: release
description: >
  Coordinate a full AgentCompany release across engineering verification, npm,
...
Run the full AgentCompany maintainer release workflow, not just an npm publish.
...
7. If running through AgentCompany, you have issue context for status updates and follow-up task creation.
...
AgentCompany now uses a commit-driven release model:
...
npm view agentcompany@canary version
```
...
- release summary in AgentCompany issue context
