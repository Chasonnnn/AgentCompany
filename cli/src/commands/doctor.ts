...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" agentcompany doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `agentcompany configure --section database` or `agentcompany onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadAgentCompanyEnvFile(input.configPath);
