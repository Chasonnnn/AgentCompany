...
const DATA_DIR_OPTION_HELP =
  "AgentCompany data directory root (isolates state from ~/.agentcompany)";

program
  .name("agentcompany")
  .description("AgentCompany CLI — setup, diagnose, and configure your instance")
  .version(cliVersion);
...
program.hook("preAction", (_thisCommand, actionCommand) => {
  ...
  loadAgentCompanyEnvFile(options.config);
...
program
  ...
  .option("--run", "Start AgentCompany immediately after saving config", false)
  .action(onboard);

program
  .command("doctor")
  .description("Run diagnostic checks on your AgentCompany setup")
  .option("-c, --config <path>", "Path to config file")
  .option("-d, --data-dir <path>", DATA_DIR_OPTION_HELP)
...
program
  ...
  .option("--filename-prefix <prefix>", "Backup filename prefix", "agentcompany")
...
program
  .command("run")
  .description("Bootstrap local setup (onboard + doctor) and run AgentCompany")
  .option("-c, --config <path>", "Path to config file")
  .option("-d, --data-dir <path>", DATA_DIR_OPTION_HELP)
...
heartbeat
  ...
  .option("--api-base <url>", "Base URL for the AgentCompany server API")
