...
Eval framework for testing AgentCompany agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the AgentCompany heartbeat skill:
