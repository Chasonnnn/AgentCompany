...
vi.mock("@agentcompany/shared/telemetry", async () => {
  const actual = await vi.importActual<typeof import("@agentcompany/shared/telemetry")>(
    "@agentcompany/shared/telemetry",
  );
  return {
    ...actual,
