...
import { models as codexFallbackModels } from "@agentcompany/adapter-codex-local";
import { models as cursorFallbackModels } from "@agentcompany/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@agentcompany/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@agentcompany/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.AGENTCOMPANY_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.AGENTCOMPANY_OPENCODE_COMMAND = "__paperclip_missing_opencode_command__";
