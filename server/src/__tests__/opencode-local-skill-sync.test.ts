...
describe("opencode local skill sync", () => {
  ...
  it("reports configured AgentCompany skills and installs them into the shared Claude/OpenCode skills home", async () => {
    ...
    const after = await syncOpenCodeSkills(ctx, [agentcompanyKey]);
  ...
  it("keeps required bundled AgentCompany skills installed even when the desired set is emptied", async () => {
    ...
    await syncOpenCodeSkills(configuredCtx, [agentcompanyKey]);
