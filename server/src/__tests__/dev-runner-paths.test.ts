...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local AgentCompany state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".agentcompany/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/paperclip",
      ),
    ).toBe(false);
