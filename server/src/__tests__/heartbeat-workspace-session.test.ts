...
import type { agents } from "@agentcompany/db";
import { sessionCodec as codexSessionCodec } from "@agentcompany/adapter-codex-local/server";
...
describe("comment wake batching", () => {
  it("preserves ordered wake comment ids when coalescing queued follow-up wakes", () => {
    ...
    expect(merged.agentcompanyWake).toBeUndefined();
  });
});
...
describe("parseSessionCompactionPolicy", () => {
  it("disables AgentCompany-managed rotation by default for codex and claude local", () => {
