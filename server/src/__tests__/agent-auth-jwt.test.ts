...
describe("agent local JWT", () => {
  const secretEnv = "AGENTCOMPANY_AGENT_JWT_SECRET";
  const ttlEnv = "AGENTCOMPANY_AGENT_JWT_TTL_SECONDS";
  const issuerEnv = "AGENTCOMPANY_AGENT_JWT_ISSUER";
  const audienceEnv = "AGENTCOMPANY_AGENT_JWT_AUDIENCE";
