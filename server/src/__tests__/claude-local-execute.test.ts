...
describe("claude execute", () => {
  ...
  it("classifies rate-limit and overloaded failures without reset metadata as transient", async () => {
  ...
  it("does not reclassify deterministic Claude failures as transient", async () => {
