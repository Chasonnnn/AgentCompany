...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@agentcompany/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: AgentCompanyPluginManifestV1, pluginDbId?: string): void;
