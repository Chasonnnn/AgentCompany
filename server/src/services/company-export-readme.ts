 ...
 */
import type { CompanyPortabilityManifest } from "@agentcompany/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [AgentCompany](https://github.com/chason/agentcompany)");
  lines.push("");
