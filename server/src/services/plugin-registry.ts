 ...
 * the AgentCompany service layer.
 *
...
export function pluginRegistryService(db: Db) {
  ...
  return {
     ...
     */
    install: async (input: InstallPlugin, manifest: AgentCompanyPluginManifestV1) => {
    ...
    /**
     * Create or update a persistent mapping between a AgentCompany object and an
     * external entity.
     *
     * @param pluginId - The UUID of the plugin.
