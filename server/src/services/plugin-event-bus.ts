/**
 * PluginEventBus — typed in-process event bus for the AgentCompany plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@agentcompany/shared";
import type { PluginEvent, EventFilter } from "@agentcompany/plugin-sdk";
