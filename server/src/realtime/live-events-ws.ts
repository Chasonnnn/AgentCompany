...
import { agentApiKeys, companyMemberships, instanceUserRoles } from "@agentcompany/db";
import type { DeploymentMode } from "@agentcompany/shared";
...
interface IncomingMessageWithContext extends IncomingMessage {
  agentcompanyUpgradeContext?: UpgradeContext;
}
...
export function setupLiveEventsWebSocketServer(
  ...
  wss.on("connection", (socket: WsSocket, req: IncomingMessage) => {
    const context = (req as IncomingMessageWithContext).agentcompanyUpgradeContext;
    if (!context) {
  ...
  server.on("upgrade", (req, socket, head) => {
    ...
    void authorizeUpgrade(db, req, companyId, url, {
      ...
      .then((context) => {
        ...
        reqWithContext.agentcompanyUpgradeContext = context;
