...
import * as serverUtils from "@agentcompany/adapter-utils/server-utils";
export type { RunProcessResult } from "@agentcompany/adapter-utils/server-utils";
...
export const buildAgentCompanyEnv = serverUtils.buildAgentCompanyEnv;
...
export function buildInvocationEnvForLogs(
  ...
  // TODO: Remove this fallback once @agentcompany/adapter-utils exports buildInvocationEnvForLogs everywhere we consume it.
