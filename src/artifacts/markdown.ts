...
const REQUIRED_HEADINGS: Record<ArtifactType, readonly string[]> = {
  ...
  meeting_transcript: ["## Attendees", "## Discussion", "## Decisions", "## Open Questions"],
  department_plan: ["## Scope", "## Deliverables", "## Risks", "## Dependencies"],
  executive_plan: ["## Executive Summary", "## Department Plans", "## Dependencies", "## Approval"],
