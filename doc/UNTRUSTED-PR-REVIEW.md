...
This is intentionally separate from the normal AgentCompany dev image.
...
```sh
review-checkout-pr agentcompany/agentcompany 432
cd /work/checkouts/agentcompany-paperclip/pr-432
```
...
## Preview the AgentCompany app from the PR
...
- AgentCompany's embedded PostgreSQL and local storage stay inside the container home volume via `AGENTCOMPANY_HOME=/home/reviewer/.agentcompany-review`.
