...
Paperclip’s core identity is a **control plane for autonomous AI companies**, centered on **companies, org charts, goals, issues/comments, documents, conference rooms, heartbeats, budgets, approvals, and board governance**. The public docs are also explicit about the current boundaries: **issues/comments are the default execution channel, while documents, conference rooms, approvals, and shared-service engagements handle durable artifacts, leadership coordination, governed decisions, and consulting**; Paperclip is **not a chatbot**, and it is **not a code review tool**. The roadmap already points toward **easier onboarding, cloud agents, easier agent configuration, plugins, better docs, and ClipMart/ClipHub-style reusable companies/templates**.
