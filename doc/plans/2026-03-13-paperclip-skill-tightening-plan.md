# AgentCompany Skill Tightening Plan
...
- preserve all current AgentCompany control-plane capabilities
...
- changing AgentCompany API semantics
...
- add at least lightweight eval or scripted scenario coverage for key AgentCompany flows
- confirm how adapter/bootstrap layering should load skill content versus references

## Success Criteria

- materially lower first-run input tokens for AgentCompany-coordinated agents
