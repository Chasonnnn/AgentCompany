...
- `skills/agentcompany/SKILL.md` and `skills/agentcompany/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.1 `skills/agentcompany/SKILL.md`
...
## 6.2 `skills/agentcompany-create-agent/SKILL.md`
