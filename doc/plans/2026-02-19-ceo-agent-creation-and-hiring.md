...
- installed adapter list for this AgentCompany instance
...
## 8. New Skill: `agentcompany-create-agent`

Create new skill directory:

- `skills/agentcompany-create-agent/SKILL.md`
...
Also update `skills/agentcompany/SKILL.md` to reference this skill for hiring workflows.
...
- `agentcompany-create-agent` skill + docs updates
