...
AgentCompany already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model AgentCompany should implement next.

## Product Goals

AgentCompany should let operators:
...
For the next implementation pass, AgentCompany should enforce these defaults:
...
AgentCompany should separate subscription-included usage from billed spend:
...
AgentCompany should have two threshold classes:
...
AgentCompany must know that a project is budget-paused and enforce it.
...
AgentCompany must also block execution before new work starts.
