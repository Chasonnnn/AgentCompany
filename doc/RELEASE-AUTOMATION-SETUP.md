...
This document covers the GitHub and npm setup required for the current AgentCompany release model:
...
Do this for every public package that AgentCompany publishes.
...
3. add a trusted publisher for the GitHub repository `agentcompany/agentcompany`
...
2. revoke any personal automation token that used to publish AgentCompany
