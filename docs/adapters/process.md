...
- Running a Python script that calls the AgentCompany API
...
1. AgentCompany spawns the configured command as a child process
2. Standard AgentCompany environment variables are injected (`AGENTCOMPANY_AGENT_ID`, `AGENTCOMPANY_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the AgentCompany API and perform work.
