...
Manage companies within your AgentCompany instance.
...
Company logo uploads use the normal AgentCompany attachment size limit.
...
| `logoUrl` | string | Optional AgentCompany asset content path for the stored logo image |
