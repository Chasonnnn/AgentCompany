...
- `AGENTCOMPANY_APPROVAL_ID` — the resolved approval
- `AGENTCOMPANY_APPROVAL_STATUS` — `approved` or `rejected`
- `AGENTCOMPANY_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
