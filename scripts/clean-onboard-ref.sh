...
Environment overrides:
  ...
  PC_DATA=/tmp/data           AgentCompany data dir to use
  AGENTCOMPANY_HOST=127.0.0.1    Host passed to the onboarded server
  AGENTCOMPANY_PORT=3232         Port passed to the onboarded server
...
export AGENTCOMPANY_HOST="${AGENTCOMPANY_HOST:-127.0.0.1}"
export AGENTCOMPANY_PORT="${AGENTCOMPANY_PORT:-3100}"
export AGENTCOMPANY_OPEN_ON_LISTEN="${AGENTCOMPANY_OPEN_ON_LISTEN:-false}"
...
echo "AGENTCOMPANY_HOST: $AGENTCOMPANY_HOST"
echo "AGENTCOMPANY_PORT: $AGENTCOMPANY_PORT"
...
env \
  ...
  HOST="$AGENTCOMPANY_HOST" \
  PORT="$AGENTCOMPANY_PORT" \
  AGENTCOMPANY_OPEN_ON_LISTEN="$AGENTCOMPANY_OPEN_ON_LISTEN" \
  pnpm agentcompany onboard --yes --data-dir "$PC_DATA"
